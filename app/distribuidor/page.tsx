...
const pacotes = [
  {
    ...
    opcoes: [
      { tipo: "Moído", peso: "250g", preco: "R$20,56" },
      { tipo: "Moído", peso: "500g", preco: "R$34,96" },
      { tipo: "Em Grãos", peso: "250g", preco: "R$21,36" },
      { tipo: "Em Grãos", peso: "500g", preco: "R$34,96" },
      { tipo: "Em Grãos", peso: "1kg", preco: "R$70,96" },
    ],
  },
  {
    nome: "Canastra Suave",
  ...
  // Agora os especiais
  {
    ...
    opcoes: [
      { tipo: "Moído", peso: "250g", preco: "R$23,76" },
      { tipo: "Em Grãos", peso: "250g", preco: "R$23,76" },
    ],
  },
  {
    ...
    opcoes: [
      { tipo: "Moído", peso: "500g", preco: "R$31,76" },
      { tipo: "Em Grãos", peso: "1kg", preco: "R$66,16" },
    ],
  },
];
    ...
    produtos: [
      {
        ...
        notas: { docura: 3, acidez: 3, corpo: 4, amargor: 3 },
        opcoes: [
          { tipo: "Display (10 unid. de sachês)", preco: "R$19,92" },
        ],
      },
      {
        ...
        opcoes: [
          { tipo: "Display (10 unid. de cápsulas)", preco: "R$14,16" },
        ],
      },
      {
    ...
    produtos: [
      {
        ...
        opcoes: [
          { tipo: "Canastra Clássico ou Suave", peso: "2kg em grãos", preco: "R$115,76" },
        ],
      },
    ],
  },
