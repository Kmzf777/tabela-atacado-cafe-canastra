...
const pacotes = [
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "250g", preco: "USD$5.42" },
      { tipo: "Molido", peso: "500g", preco: "USD$9.45" },
      { tipo: "En Granos", peso: "250g", preco: "USD$5.60" },
      { tipo: "En Granos", peso: "500g", preco: "USD$9.45" },
      { tipo: "En Granos", peso: "1kg", preco: "USD$19.13" },
    ],
  },
  {
    nome: "Canastra Suave",
  ...
  // Ahora los especiales
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "250g", preco: "USD$6.15" },
      { tipo: "En Granos", peso: "250g", preco: "USD$6.15" },
    ],
  },
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "500g", preco: "USD$8.72" },
      { tipo: "En Granos", peso: "1kg", preco: "USD$18.04" },
    ],
  },
];
    ...
    produtos: [
      {
        ...
        notas: { docura: 3, acidez: 3, corpo: 4, amargor: 3 },
        opcoes: [
          { tipo: "Display (10 unid. de sobres)", preco: "USD$5.28" },
        ],
      },
      {
        ...
        opcoes: [
          { tipo: "Display (10 unid. de cápsulas)", preco: "USD$3.22" },
        ],
      },
      {
