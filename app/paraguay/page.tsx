...
const pacotes = [
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "250g", preco: "USD$5.37" },
      { tipo: "Molido", peso: "500g", preco: "USD$8.34" },
      { tipo: "En Granos", peso: "250g", preco: "USD$5.57" },
  ...
  // Ahora los especiales
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "250g", preco: "USD$6.17" },
      { tipo: "En Granos", peso: "250g", preco: "USD$6.17" },
    ],
  },
  {
  ...
  },
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "500g", preco: "USD$7.47" },
  ...
  },
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "500g", preco: "USD$5.37" },
  ...
  },
  {
    ...
    opcoes: [
      { tipo: "Molido", peso: "500g", preco: "USD$4.97" },
...
export default function Paraguay() {
  return (
